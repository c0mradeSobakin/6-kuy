...
where h, m, s (h for hour, m for minutes, s for seconds) are positive or null integer 
(represented as strings) with one or two digits. Substrings in the input string are separated by , or ,.
...
when there is an odd number of observations. If there is an even number of observations, 
